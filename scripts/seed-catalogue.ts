...
const CATALOGUE: Seed[] = [
  ...
  // Top 100: the public-domain, mappable titles from the greatest-books canon.
  {
    ...
    country: 'ch',
    ordering: 'chapter',
    why: 'Seven years in a sanatorium above Davos, where Hans Castorp goes up for a three-week visit and forgets to leave. Mann sets the whole novel on one Alpine shelf, the real cure-town still there, and makes time itself the subject.',
  },
  {
    ...
    country: 'gb',
    ordering: 'chapter',
    why: 'Pip’s London: Newgate and the Old Bailey, the Temple, Jaggers’s office in Little Britain, Wemmick’s wooden castle at Walworth. Dickens threads the Kent marshes to the city and back, and the money is always dirtier than it looks.',
  },
  {
    ...
    country: 'gb',
    ordering: 'chapter',
    why: 'The moors above Haworth, where Top Withens still stands in for the Heights and the wind never stops. Brontë invents the two houses but keeps the real Pennine ground between them, an hour’s walk that is the whole novel.',
  },
  {
    ...
    country: 'gb',
    ordering: 'chapter',
    why: 'Nominally the Isle of Skye, but built from the Woolfs’ summers at Talland House in St Ives, looking out to the Godrevy light. The bay, the house, and ten years passing inside a single bracket.',
  },
  {
    ...
    country: 'gb',
    ordering: 'chapter',
    why: 'Almost every house in it is invented, but Darcy’s Pemberley is Derbyshire, and readers have walked Chatsworth near Bakewell for it ever since. A novel that will exercise inspired_by as hard as any on the list.',
  },
  {
    ...
    country: 'us',
    ordering: 'chapter',
    why: 'Faulkner’s Yoknapatawpha is Lafayette County, Mississippi, and its Jefferson is Oxford, where he lived and is buried. The Compson place, the branch, the courthouse square, all drawn from ground he could see.',
  },
  {
    title: 'The Decameron',
    ...
    country: 'it',
    ordering: 'chapter',
    why: 'Ten young Florentines flee the Black Death of 1348 to a villa in the hills above the city and tell a hundred tales. The frame is real Florence and Fiesole, emptied by plague, which is exactly what the historical layer is for.',
  },
  {
    title: 'Don Quixote',
    ...
    country: 'es',
    ordering: 'chapter',
    why: 'La Mancha, and the windmills at Campo de Criptana he charges as giants, still turning on their ridge. Cervantes sends the knight roaming a real, dusty plain of inns and villages, and it brings Spain into the atlas.',
  },
];
